...
AP/modem characterization is frozen; read-only physical validation is complete for the SIM-independent predictions; write validation is deferred and separately authorized. Hardware, boot and RF areas remain at an earlier stage. Findings may be incomplete or revised as additional evidence becomes available.
